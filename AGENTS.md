...
**Last agent action:** Published **v1.0.0 build 22** — smarter avatar prompts + slim Creation Center character cards (no scenario/greetings/per-card prompts).
