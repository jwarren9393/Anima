...
| Verified end-to-end | ✅ `flutter doctor` clean · `flutter analyze` clean · **379 tests pass** · Linux release built + installed to `~/.local/share/anima/` (menu entry + icon) via `./scripts/update_linux.sh` |
